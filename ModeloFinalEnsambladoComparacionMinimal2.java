...
public class ModeloFinalEnsambladoComparacionMinimal2 {
    public ModeloFinalEnsambladoComparacionMinimal2() {
        super();
    }
    ...
    public static String[] results = new String[]{
        "./results/4.final/final_model_comparison_minimal_2_stats_data_filled_r.csv",
        "./results/4.final/final_model_comparison_minimal_2_stats_data_filled_weka.csv"
    };
