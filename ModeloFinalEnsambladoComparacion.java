...
public class ModeloFinalEnsambladoComparacion {
    public ModeloFinalEnsambladoComparacion() {
        super();
    }
    ...
    public static String[] results = new String[]{
        "./results/4/final_model_comparison_stats_data_filled_r.csv",
        "./results/4/final_model_comparison_stats_data_filled_weka.csv"
    };
