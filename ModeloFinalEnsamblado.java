...
public class ModeloFinalEnsamblado {
    public ModeloFinalEnsamblado() {
        super();
    }
    ...
    public static String[] results = new String[]{
        "./results/4/final_model_stats_data_filled_r.csv",
        "./results/4/final_model_stats_data_filled_weka.csv"
    };
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int j=0; j < datasets.length; j++) {
            ModeloFinalEnsamblado parseStats = new ModeloFinalEnsamblado();
        ...
        promedio /= 2;
        System.out.println("ModeloFinalEnsamblado" + "," + String.valueOf(promedio));
    }
}